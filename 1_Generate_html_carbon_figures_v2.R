############ GLOBAL CARBON FOOTPRINT DISTRIBUTION GRAPH #######################
...
setwd("C:/Users/tzvet/Pictures/Kings MA/CORE RA/GlobalCarb") # set to github dir
...
WIDraw$country[WIDraw$country== "Viet Nam"] <- "Vietnam"
WIDraw$country[WIDraw$country== "Cote d'Ivoire"] <- "Ivory Coast"
...
full <- full[which(full$country!="Korea" & full$country!=1997),]
WIDraw$country[WIDraw$country== "Korea"] <- "South Korea"
full$carb_incdec10[full$year == 1997 & full$country== "Singapore" ] <- 74
# Probably a coding error on Singapore in 1997, so we better drop it 
full <- full[which(full$country!="Singapore" & full$country!=1997),]
...
order_year <- full[which(full$year=="1990"), ] # Dataset for a single year
attach(order_year)
...
for (k in st_year:end_year){ #
  ...
  vars_list <-   c("country" ,"carb_incdec1", "carb_incdec2", 
                   "carb_incdec3", "carb_incdec4", "carb_incdec5", 
                   "carb_incdec6", "carb_incdec7", "carb_incdec8",
                   "carb_incdec9", "carb_incdec10", 
                   "col", "lab")
  ...
  cat("<body>")
  cat("\n") 
  cat("<div class = \"header\"> <center> Global Carbon Footprint Inequality - " ,paste(k),"</center> </div>", sep = "")
  cat("\n") 
  ...
  cat("<center>")
  cat("\n")    
  cat("		<title> Global Carbon Footprint Inequality | amCharts</title>")
  cat("\n")
  ...
  cat("\n")
  cat("							\"balloonText\": \"[[title]] of [[cat]]: [[value]] tonne(s)\",")
  cat("\n")
  ...
  cat("							{")
  cat("\n")
  cat("							\"balloonText\": \"Taller blocks correspond to higher carbon emissions. Countries with larger populations are assigned thicker blocks. Colours correspond to how rich the country is in 1995, with poorer countries shaded red and richer countries shaded green. Try hovering over a block to learn more!\",")
  cat("\n")
  cat("							\"category\": \"X\",")
  cat("\n")
  cat("							\"dashLength\": 4,")
  ...
  cat("							\"stackType\": \"3d\",")
  cat("\n")
  cat("							\"title\": \"Tonnes of carbon per capita\",")
  cat("\n")
  cat("							\"maximum\": 150,")
  cat("\n")
  ...
  # cat("							\"size\": 20,")
  # cat("\n")
  # cat("							\"text\": \"Global Carbon Footprint Inequality ",paste(k),"\"", sep = "")
  # cat("\n")
  # cat("						}")
  # cat("\n")
  # cat("					],")
  ...
  for (i in 1:length(final$country)) {
    ...
    cat("\n")
    cat("\"Decile 1\":"," \"",paste(final$carb_incdec1[i]),"\"",",", sep = "")
    cat("\n")
    cat("\"Decile 2\":"," \"",paste(final$carb_incdec2[i]),"\"",",", sep = "")
    cat("\n")
    cat("\"Decile 3\":"," \"",paste(final$carb_incdec3[i]),"\"",",", sep = "")
    cat("\n")
    cat("\"Decile 4\":"," \"",paste(final$carb_incdec4[i]),"\"",",", sep = "")
    cat("\n")
    cat("\"Decile 5\":"," \"",paste(final$carb_incdec5[i]),"\"",",", sep = "")
    cat("\n")
    cat("\"Decile 6\":"," \"",paste(final$carb_incdec6[i]),"\"",",", sep = "")
    cat("\n")
    cat("\"Decile 7\":"," \"",paste(final$carb_incdec7[i]),"\"",",", sep = "")
    cat("\n")
    cat("\"Decile 8\":"," \"",paste(final$carb_incdec8[i]),"\"",",", sep = "")
    cat("\n")
    cat("\"Decile 9\":"," \"",paste(final$carb_incdec9[i]),"\"",",", sep = "")
    cat("\n")
    cat("\"Decile 10\":"," \"",paste(final$carb_incdec10[i]),"\"",",", sep = "")
    cat("\n")
  ...
  cat(" <br/> <br/>")
  cat("\n")
  cat("These are detailed figures so may take a little time to load. Taller  blocks correspond to higher carbon footprints. Carboon emissions are measured by the tonnes of carbon emissions per person on average in each income decile. Countries with larger populations are assigned more blocks. Colours correspond to how rich the country is in 1990, with poorer countries shaded red and richer countries shaded green. Countries are ordered according to mean income level in each year, while holding colours fixed from the 1990 levels. Therefore  with these figures we can see inequality within and across countries over time as well as changes in average income. Try hovering over a block to learn more!")
  cat("\n")
  cat(" <br/> <br/>")
  cat("\n")
