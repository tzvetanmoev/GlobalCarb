...
setwd("C:/Users/tzvet/Pictures/Kings MA/CORE RA/core-skyscraper-3-carbon") # set to github dir
...
for (k in st_year:end_year){ #
  ...
  cat("							{")
  cat("\n")
  cat("							\"balloonText\": \"Taller blocks correspond to higher carbon emissions. Countries with larger populations are assigned wider blocks. Colours correspond to how rich the country is in 1995, with poorer countries shaded red and richer countries shaded green. Try hovering over a block to learn more!\",")
  cat("\n")
  cat("							\"category\": \"X\",")
  cat("\n")
  cat("							\"dashLength\": 4,")
  ...
  cat("							\"stackType\": \"3d\",")
  cat("\n")
  cat("							\"title\": \"Tonnes of emissions per capita\",")
  cat("\n")
  cat("							\"maximum\": 150,")
  cat("\n")
  ...
  cat("\n")
  cat(" <br/>")
  cat("Pick another year or return to the <a href=\"https://tzvetanmoev.github.io/core-skyscraper-3-carbon/\">home</a> page to download the data and learn more about the project <br /> <br />")
  cat("\n")
  #cat(" <br/>")
  if (k == 1990){
