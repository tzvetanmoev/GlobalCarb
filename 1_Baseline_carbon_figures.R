...
for (k in st_year:end_year){ #
  ...
  cat("							\"alphaField\": \"Transparency\",")
  cat("\n")
  cat("							\"balloonText\": \"[[title]] of [[cat]]: [[value]] tonnes\",")
  cat("\n")
  cat("							\"fillAlphas\": 1,")
  cat("\n")
  cat("							\"fillColors\": \"#6899b5\",")
